...
declare class Endpoint {
    ...
    oauthUpdate(appId: string, endpointId: string, endpointOauthConfigIn: EndpointOauthConfigIn): Promise<void>;
    oauthDelete(appId: string, endpointId: string): Promise<void>;
}
