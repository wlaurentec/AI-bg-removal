...
export declare class TransformationTemplateApiResponseProcessor {
    v1EndpointUpdateHubspotOauthConfig(response: ResponseContext): Promise<void>;
    ...
    v1TransformationTemplateOauthDiscord(response: ResponseContext): Promise<IncomingWebhookPayloadOut>;
    v1TransformationTemplateOauthHubspot(response: ResponseContext): Promise<OAuthPayloadOut>;
    v1TransformationTemplateOauthSlack(response: ResponseContext): Promise<IncomingWebhookPayloadOut>;
